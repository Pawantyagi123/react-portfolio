...
import { FaTwitter, FaLinkedin, FaGithub, FaArrowRight } from "react-icons/fa6";
...
export default function Home() {
  ...
  return (
    <div className="min-h-full bg-gradient-to-br from-slate-950 via-blue-950 to-slate-950 flex items-center justify-center px-6 py-28 relative overflow-hidden" id="home">
          ...
          <Fade direction="down" cascade duration={1500}>
            <div className="flex-1 space-y-8">
              ...
              <div className="flex items-center gap-4 pt-4">
                <button 
                 onClick={(e) => handleClickNavigate(e, "#project")} 
                ...
                >
                  <span className="relative z-10">View Projects</span> <FaArrowRight className="relative z-10" />
