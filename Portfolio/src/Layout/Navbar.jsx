    ...
    <>
      ...
      <div className={show ? "sidebar show" : "sidebar"}>
        ...
        <ul>
          ...
          <li>
            <NavLink to={"/skills"} onClick={handleNavbar}>
              Skill
            </NavLink>
          </li>
          <li>
            <NavLink to={"/projects"} onClick={handleNavbar}>
              Projects
            </NavLink>
          </li>
          <li>
        ...
        <div className="socialnav-links">
          <div className="hero-social-link">
            <Tippy
              placement="bottom"
              content={<span style={{ color: "white" }}>Linkdin</span>}
            >
              <a
          ...
          <div className="hero-social-link">
            <Tippy
              placement="bottom"
              content={<span style={{ color: "white" }}>Twitter</span>}
            >
              <a
          ...
          <div className="hero-social-link">
            <Tippy
              placement="bottom"
              content={<span style={{ color: "white" }}>Github</span>}
            >
              <a
          ...
          <div className="hero-social-link">
            <Tippy
              placement="bottom"
              content={<span style={{ color: "white" }}>Dev.to</span>}
            >
              <a
